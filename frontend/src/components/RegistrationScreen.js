...
const RegistrationScreen = () => {
    const initialFormState = {
        ...
        'Outra Identificacao': '',
        'Observacao': '',
        'Foto': '' // Trataremos como um campo de URL por enquanto
    };
    ...
    // Busca a lista de setores existentes para popular o dropdown
    useEffect(() => {
                        ...
                        <div className="form-grid">
                            ...
                            <div className="form-group">
                             ...
                             <div className="form-group">
                                ...
                                <input type="text" name="Foto" value={formData.Foto} onChange={handleChange} placeholder="https://exemplo.com/imagem.png" />
                            </div>
                            <div className="form-group full-width">
